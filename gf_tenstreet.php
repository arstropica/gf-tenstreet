...
function pre_activation_gf_tenstreet() {
	GF_TenStreet::set_default_client_field('gf_tenstreet_worklist', true);
}
...
register_activation_hook( __FILE__ , 'pre_activation_gf_tenstreet' );
